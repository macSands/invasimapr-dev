...
Ready to contribute? Here is how to set up `invasimapr` for local
development.
...
This contributing guide is adapted from the [usethis contributing
template](https://usethis.r-lib.org/reference/use_tidy_contributing.html).
